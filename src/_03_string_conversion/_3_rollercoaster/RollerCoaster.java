...
String input=JOptionPane.showInputDialog("Please enter your height in inches.");
int heightAsInt=Integer.parseInt(input);
if (heightAsInt>=48) {
	JOptionPane.showMessageDialog(null, "Hooray! You are tall enough to ride the roller coaster alone!");	
}
